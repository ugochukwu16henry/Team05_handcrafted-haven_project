      ...
      <div className="auth-form-card rounded-[10px] p-5 sm:p-8 transition-shadow duration-200 w-full max-w-[100%]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div>
            ...
            />
            {emailError && (
              <span id="email-error" className="block mt-1.5 text-sm text-red-600" role="alert">
                {emailError}
              </span>
            )}
          </div>
          ...
          <div>
            ...
            {passwordError && (
              <span id="password-error" className="block mt-1.5 text-sm text-red-600" role="alert">
                {passwordError}
              </span>
            )}
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" name="remember" className="w-4 h-4 rounded border-border-color text-accent-header focus:ring-accent-header" />
              <span className="text-text-secondary">Remember me</span>
            </label>
            <Link
              href="/forgot-password"
              className="text-accent-header font-medium hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-header focus-visible:ring-offset-2 rounded"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center text-sm text-text-secondary mt-6">
          ...
          <Link href="/signup" className="font-semibold text-accent-header hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-header focus-visible:ring-offset-2 rounded">
            Create account
          </Link>
        </p>
      </div>
